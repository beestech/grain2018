<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_GoodAllocate.aspx.cs" Inherits="Web.User.Goods.user_GoodAllocate" %>
            ...
            <HeaderTemplate>
                <table class="tabData">
                    <tr class="tr_head">
                        ...
                        <th style="min-width: 120px; text-align: center;">商品
                        </th>
                        <th style="min-width: 80px; text-align: center;">数量
                        </th>
                        <th style="min-width: 80px; text-align: center;">价格
                        </th>
                        <th style="min-width: 100px; text-align: center;">时间
                        </th>
                        <th style="min-width: 80px; text-align: center;">操作人
                        </th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
