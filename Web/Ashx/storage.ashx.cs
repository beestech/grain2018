...
namespace Web.Ashx
{
    ...
    public class storage : IHttpHandler, IRequiresSessionState
    {
        ...
        void getDepOperateLogAll(HttpContext context)
        {
           ...
           if (context.Request.Form["Qdtend"] != null)
           {
            ...
            if (dt == null || dt.Rows.Count == 0)
            {
                ...
                strSqlCommune.Append(" LEFT OUTER  join StorageInterest as i on i.Dep_SID = A.Dep_SID");
        ...
        void PrintDep_StorageInfo(HttpContext context)
        {
            ...
            string numInterest = "0";//利息
            if (context.Request.Form["numInterest"] != null) {
                numInterest = context.Request.Form["numInterest"].ToString();
            }
          ...
          //  sql.Append(" where BusinessNO='" + BusinessNO + "' and  A.AccountNumber='" + AccountNumber + "'");
           ...
           string WBName = dtLog.Rows[0]["WBName"].ToString();
            ...
            strReturn.Append("    <td style='width: 50px;'> <span>利息</span></td>");
            ...
            strReturn.Append("    <td> <span>￥" + numInterest + "</span></td>");
